...
# This allows the script to be run directly: python src/benchmarking/cli.py
...
def benchmark_model(
    ...
    from benchmarking.data_loader import load_test_texts
    from benchmarking.execution import run_batch_inference, run_warmup_iterations
    from benchmarking.model_loader import load_model_from_checkpoint
    from benchmarking.statistics import calculate_latency_stats
    """
    Benchmark model inference performance across different batch sizes.
