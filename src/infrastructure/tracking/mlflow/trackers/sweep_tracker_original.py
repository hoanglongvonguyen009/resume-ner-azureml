...
class MLflowSweepTracker(BaseTracker):
    ...
    def _log_best_trial_checkpoint(
        ...
        # Priority: 1) refit/checkpoint (preferred), 2) cv/foldN/checkpoint
        ...
        # Legacy structure fallback removed - only v2 structure supported
        # TODO: Remove this fallback after confirming no old runs exist with legacy checkpoint paths
        # Legacy checkpoint paths (trial_N_foldK/checkpoint, trial_N/checkpoint) are no longer supported
