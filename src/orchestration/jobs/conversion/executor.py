...
def execute_conversion(
    ...
    print(f"✓ Conversion config loaded from conversion.yaml")
    print(f"✓ Output directory: {conversion_output_dir}")
    ...
    print(f"✓ Model conversion completed. ONNX model: {onnx_model_path}")
    if run_id:
