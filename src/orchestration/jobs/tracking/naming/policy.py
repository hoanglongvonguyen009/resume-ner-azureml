...
def load_naming_policy(config_dir: Optional[Path] = None) -> Dict[str, Any]:
    """
    Load and cache naming policy from config/naming.yaml.
...
def format_run_name(
    ...
    Args:
        ...
        config_dir: Config directory (for normalization rules).
